...
func (_m *HubInterface) StartBrowseMdnsSearch() {
	_m.Called()
}

// HubInterface_StartBrowseMdnsSearch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartBrowseMdnsSearch'
type HubInterface_StartBrowseMdnsSearch_Call struct {
	*mock.Call
}

// StartBrowseMdnsSearch is a helper method to define mock.On call
func (_e *HubInterface_Expecter) StartBrowseMdnsSearch() *HubInterface_StartBrowseMdnsSearch_Call {
	return &HubInterface_StartBrowseMdnsSearch_Call{Call: _e.mock.On("StartBrowseMdnsSearch")}
}

func (_c *HubInterface_StartBrowseMdnsSearch_Call) Run(run func()) *HubInterface_StartBrowseMdnsSearch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *HubInterface_StartBrowseMdnsSearch_Call) Return() *HubInterface_StartBrowseMdnsSearch_Call {
	_c.Call.Return()
	return _c
}

func (_c *HubInterface_StartBrowseMdnsSearch_Call) RunAndReturn(run func()) *HubInterface_StartBrowseMdnsSearch_Call {
	_c.Call.Return(run)
	return _c
}

// StopBrowseMdnsSearch provides a mock function with given fields:
func (_m *HubInterface) StopBrowseMdnsSearch() {
	_m.Called()
}

// HubInterface_StopBrowseMdnsSearch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StopBrowseMdnsSearch'
type HubInterface_StopBrowseMdnsSearch_Call struct {
	*mock.Call
}

// StopBrowseMdnsSearch is a helper method to define mock.On call
func (_e *HubInterface_Expecter) StopBrowseMdnsSearch() *HubInterface_StopBrowseMdnsSearch_Call {
	return &HubInterface_StopBrowseMdnsSearch_Call{Call: _e.mock.On("StopBrowseMdnsSearch")}
}

func (_c *HubInterface_StopBrowseMdnsSearch_Call) Run(run func()) *HubInterface_StopBrowseMdnsSearch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *HubInterface_StopBrowseMdnsSearch_Call) Return() *HubInterface_StopBrowseMdnsSearch_Call {
	_c.Call.Return()
	return _c
}

func (_c *HubInterface_StopBrowseMdnsSearch_Call) RunAndReturn(run func()) *HubInterface_StopBrowseMdnsSearch_Call {
	_c.Call.Return(run)
	return _c
}
