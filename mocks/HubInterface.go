...
func (_m *HubInterface) RegisterRemoteSKI(ski string, shipID string) {
...
func (_c *HubInterface_RegisterRemoteSKI_Call) RunAndReturn(run func(string, string)) *HubInterface_RegisterRemoteSKI_Call {
	_c.Call.Return(run)
	return _c
}
